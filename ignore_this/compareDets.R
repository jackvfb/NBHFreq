...
ggplot(filter(dets, species == 'Kosp'), aes(eventId, peak))+
  geom_bin_2d()+
  ylim(c(100, 160))+
  theme(axis.text.x = element_text(angle = 90))
...
ggplot(filter(dets, species == 'Kosp', noiseLevel <= -15), aes(eventId, peak))+
  geom_bin_2d()+
  ylim(c(100, 160))+
  theme(axis.text.x = element_text(angle = 90))
...
ggplot(filter(dets, species == 'NBHF'), aes(eventId, peak))+
  geom_bin_2d()+
  ylim(c(100, 180))+
  theme(axis.text.x = element_text(angle = 90))
...
ggplot(filter(dets, species == 'NBHF', noiseLevel <= -15), aes(eventId, peak))+
  geom_bin_2d()+
  ylim(c(100, 180))+
  theme(axis.text.x = element_text(angle = 90))

ggplot(filter(dets, species == 'Kosp', noiseLevel <= -15))+
...
ggplot(filter(dets, species == "Kosp", numPk == 1, noiseLevel <= -30))+
  geom_point(aes(BW_3dB, centerkHz_3dB))

ggplot(filter(dets, species == "NBHF", numPk == 1, noiseLevel <= -30))+
  geom_point(aes(BW_3dB, centerkHz_3dB))
