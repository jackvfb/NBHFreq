...
bant1 <- readRDS("analysis/data/derived_data/first_training/bant1_all.Rds")
...
bant2 <- readRDS("analysis/data/derived_data/second_training/bant2_all.rds")
...
bant2.pk <- readRDS("analysis/data/derived_data/second_training/bant2_num.Rds")
event2.pk.rf <- getBanterModel(bant2.pk)
detector2.pk1.rf <- getBanterModel(bant2.pk, "pk1")
detector2.pk2.rf <- getBanterModel(bant2.pk, "pk2")
detector2.pk3.rf <- getBanterModel(bant2.pk, "pk3")
